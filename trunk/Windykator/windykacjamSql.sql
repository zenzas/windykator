...
--
-- Host: localhost
-- Czas wygenerowania: 03 Lis 2013, 18:57
...
CREATE TABLE `sprawy` (
  ...
  `przyczyna_zakonczenia` enum('nieskuteczna egzekucja','przekazanie innemu organowi','zaspokojenie wierzycieli','umorzenie na żądanie') DEFAULT NULL,
...
--
-- Struktura tabeli dla tabeli `wierzyciel_typ`
--
...
--
-- Zrzut danych tabeli `wierzyciel_typ`
--
