<?=form_open('zadluzenie/dodaj',array('id' => 'dodaj_zadluzenie'))?>
<p>
	...
	<?=form_dropdown('wierzyciel',array(),'',"id='wierzyciel'")?>
...
<p>
	<?=form_submit('submit', 'DODAJ ZADŁUŻENIE')?>
...
<script>
	...
	<?foreach ($wierzyciele as $id_sprawy => $sprawa):?>
		...
		<?endforeach?>
	<?endforeach?>
	SynchronizedDropDown('dluznik', 'wierzyciel', values, true);
</script>
